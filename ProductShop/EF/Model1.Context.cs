...
namespace ProductShop.EF
{
    ...
    public partial class ProductShopEntities : DbContext
    {
        ...
        public virtual DbSet<CostOrder> CostOrders { get; set; }
        ...
        public virtual int GetSumm(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetSumm", idParameter);
        }
    }
}
